...
public class ChartPanel extends JPanel {
    ...
    private void renderBarChart(Graphics graphics) {
        ...
        if (chartMode.equals(SHARED_DISPLAY)) {
            ...
            renderSingleBarChart(graphics, barTitle[0]);
        }
    }

    private void renderSingleBarChart(Graphics graphics, String str) {
        int bottomY = 500;
        ...
        graphics.drawString(str, 130, 400);
    }

    private void renderSharedBarChart(Graphics graphics, String[] barTitle) {
        graphics.setColor(Color.CYAN);
        int bottomY = 300;
